...
@repo           : https://github.com/weizmannk/http://cbc-population-distributions.git
...
class BNSInspiralRangeCalculator:
    ...
    def plot_sensitivity_curves(self, run_names, outdir):
        ...
        colors = [
            ...
            "#CC0000",
            "#009E73",
        ]  # sns.color_palette("colorblind", len(run_names))
        ...
        ax.set_title(r"\textbf{O5 Sensitivity Curves}", fontsize=14)
        ...
        for irun, run_name in enumerate(run_names):
            ...
            for ifo in self.ifos:
                ...
                # Skip L1: already represented by H1 as "LIGO (L1-H1)"
                if ifo == "L1":
                    continue
                ...
                ax.loglog(
                    ...
                    linewidth=1.5,
                    label="_nolegend_",  # legend built manually below
                )
        ...
        ax.grid(True)
        ax.set_title("O5 Sensitivity Curves", fontsize=14)

        plt.tight_layout(pad=0.5)
        # plt.savefig(f"{outdir}/Strain_O5_HLV.pdf", dpi=300, bbox_inches="tight")
        # plt.savefig(f"{outdir}/Strain_O5_HLV.png", dpi=300, bbox_inches="tight")
        # plt.savefig(f"{outdir}/Strain_O5_HLV.svg", dpi=300, bbox_inches="tight")
        plt.show()
        plt.close()
